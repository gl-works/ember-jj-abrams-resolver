...
(function() {
  /*globals embdef registry embreqjs */

  embdef("ember/resolver",
      [],
      function() {
        "use strict";

        if (typeof embreqjs.entries === 'undefined') {
          embreqjs.entries = embreqjs._eak_seen;
        }
        ...
        function resolveOther(parsedName) {
          ...
          if (normalizedModuleName) {
            var module = embreq(normalizedModuleName, null, null, true /* force sync */);
        ...
        var Resolver = Ember.DefaultResolver.extend({
          ...
          findModuleName: function(parsedName, loggingDisabled){
            ...
            this.get('moduleNameLookupPatterns').find(function(item) {
              var moduleEntries = embreqjs.entries;
...
(function() {
  ...
  embdef("ember/container-debug-adapter",
      [],
      function() {
        "use strict";
          ...
          catalogEntriesByType: function(type) {
            ...
            for(var key in entries) {
              if(entries.hasOwnProperty(key) && key.indexOf(type) !== -1)
              {
                ...
                // module = embreq(key, null, null, true);
  ...
  (function() {
    ...
    Ember.Application.initializer({
      ...
      initialize: function(container) {
        var ContainerDebugAdapter = embreq('ember/container-debug-adapter');
        var Resolver = embreq('ember/resolver');
